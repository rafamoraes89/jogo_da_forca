...
function apertarLetra_v() {
	...
	document.getElementById('v_').className = 'btn btn-success btn-lg'
...
function apertarLetra_i() {
	...
	document.getElementById('i_').className = 'btn btn-success btn-lg'
...
function apertarLetra_e() {
	...
	document.getElementById('e_').className = 'btn btn-success btn-lg'
...
function youWin() {
		...
		if(v=='V' && i=='I' && o=="O" && l=="L" && e=="E" && t=="T" && a=="A") {
...
function youLose() {
	...
	let go = b1+c1+d1+f1+g1+h1+j1+k1+m1+n1+p1+q1+r1+s1+u1+w1+x1+y1+z1
