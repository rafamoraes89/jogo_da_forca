function apertarLetra_l() {
	...
	document.getElementById('l_').className = 'btn btn-success btn-lg'
...
function apertarLetra_a() {
	...
	document.getElementById('a2_').className = 'btn btn-success btn-lg'
	document.getElementById('a3_').className = 'btn btn-success btn-lg'
...
function apertarLetra_r() {
	...
	document.getElementById('r_').className = 'btn btn-success btn-lg'
...
function apertarLetra_n() {
	...
	document.getElementById('n_').className = 'btn btn-success btn-lg'
...
function apertarLetra_j() {
	...
	document.getElementById('j_').className = 'btn btn-success btn-lg'
...
function youWin() {
		...
		document.getElementById("parabens").className = "col-8 col2g"
...
function youLose() {
	...
	let go = b1+c1+d1+e1+f1+g1+h1+i1+k1+m1+o1+p1+q1+s1+t1+u1+v1+w1+x1+y1+z1
